...
<head>
    ...
    <title>Home | Booking Code - Hotel Management</title>
</head>
<body>
    <!-- Header -->
                    ...
                    <div class="management__dashboard">
                        <div class="management__dashboard-upper">
                            <ul class="management__dashboard-heading-list">
                                ...
                                <li class="management__dashboard-heading-item">
                                    <a class="square-btn management__dashboard-heading-link active">All Booking Code</a>
                                </li>
                                <li class="management__dashboard-heading-item">
                                    <a href="/manager/home/customer" class="square-btn management__dashboard-heading-link">All Customer</a>
                                </li>
                            </ul>
                            <div class="management__dashboard-monitor">
                                <input type="hidden" data-csrf-token="1" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                <form action="/manager/home/bookingCode" method="get" class="management__dashboard-search">
                                        ...
                                        <c:if test="${bookingCodeList.size() > 0}">
                                            <c:forEach items="${bookingCodeList}" var="bc">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="pill-btn blue-type-btn management__bookingcode-table-view-detail">Details</div>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </c:if>
    ...
    <script src="/assets/js/staff/manager-bookingCode.js"></script>
</body>
</html>
