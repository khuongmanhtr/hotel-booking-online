...
<head>
    ...
    <title>Home | Customer - Hotel Management</title>
</head>
<body>
    <!-- Header -->
                        ...
                        <div class="management__dashboard-upper">
                            <ul class="management__dashboard-heading-list">
                                <li class="management__dashboard-heading-item">
                                    <a href="/manager/home/active" class="square-btn management__dashboard-heading-link">All Active Room</a>
                                </li>
                                <li class="management__dashboard-heading-item">
                                    <a href="/manager/home/bookingCode" class="square-btn management__dashboard-heading-link">All Booking Code</a>
                                </li>
                                <li class="management__dashboard-heading-item">
                                    <a class="square-btn management__dashboard-heading-link active">All Customer</a>
                                </li>
                            </ul>
                            <div class="management__dashboard-monitor">
                                <form action="" method="" class="management__dashboard-search">
                                    ...
                                    <div class="management__dashboard-search-form input-row">
                                        ...
                                        <!-- <input type="text" name="searchValue" class="management__dashboard-search-input" value=""/> -->
                                    </div>
                                ...
                                <div class="table-background-layer">
                                    <table class="table-foreground-layer management__customer-table">
                                        <thead>
                                            <tr>
                                                <th>customer</th>
                                                <th>booking code</th>
                                                <th>room promotion</th>
                                                <th>service promotion</th>
                                        ...
                                        <tbody>
                                            <c:if test="${customerList.size() > 0}">
                                                <c:forEach var="c" items="${customerList}">
                                                    <tr>
                                                        <td>${c.name}</td>
                                                        <td>${c.bookingCodeDetail.bookingCode}</td>
                                                        <c:choose>
                                                            <c:when test="${c.roomPromotionCode.code != null}">
                                                                <td>${c.roomPromotionCode.code}</td>
                                                            </c:when>
                                                            <c:otherwise>
                                                                <td>Not Have</td>
                                                            </c:otherwise>
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${c.servicePromotionCode.code != null}">
                                                                <td>${c.servicePromotionCode.code}</td>
                                                            </c:when>
                                                            <c:otherwise>
                                                                <td>Not Have</td>
                                                            </c:otherwise>
                                                        ...
                                                        <td>
                                                            <fmt:formatNumber type="number" value="${c.advancePayment}" pattern="###,###"/>
                                                        </td>
                                                        <td>${c.bankAccount}</td>
                                                    </tr>
                                                </c:forEach>
                                    ...
                                    <c:if test="${customerList.size() == 0 || customerList == null}">
                                            ...
                                            <c:when test="${paginationList.size() > 0}">
                                                <div class="pagination__prev">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <a href="/manager/home/${directory}?page=${pageIndex - 1}&searchValue=${searchValue}&filter=${filter}" class="pagination__prev-link">
                                                                <i class="fas fa-chevron-left"></i>
                                                            </a>
                                                        </c:otherwise>
                                                    </c:choose>
                                                ...
                                                <ul class="pagination__page">
                                                    <c:forEach items="${paginationList}" var="pagination" varStatus="status">
                                                        <li class="pagination__page-number">
                                                            ...
                                                            <c:if test="${indexOfPageIndex != status.index}">
                                                                <a href="/manager/home/${directory}?page=${pagination}&searchValue=${searchValue}&filter=${filter}" class="pagination__page-link">${pagination}</a>
                                                            </c:if>
                                                        </li>
                                                    </c:forEach>
                                                </ul>
                                                ...
                                                <div class="pagination__next">
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <a href="/manager/home/${directory}?page=${pageIndex + 1}&searchValue=${searchValue}&filter=${filter}" class="pagination__next-link">
                                                                <i class="fas fa-chevron-right"></i>
                                                            </a>
                                                        </c:otherwise>
                                                    </c:choose>
    ...
    <script src="/assets/js/staff/manager-customer.js"></script>
</body>
</html>
