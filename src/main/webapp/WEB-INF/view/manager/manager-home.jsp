                    ...
                    <div class="management__dashboard">
                        <div class="management__dashboard-upper">
                            ...
                            <div class="management__dashboard-monitor">
                                <form action="/manager/home/active" method="get" class="management__dashboard-search">
                                            ...
                                            <c:when test="${paginationList.size() > 0}">
                                                <div class="pagination__prev">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <a href="/manager/home/active?page=${pageIndex - 1}&searchValue=${searchValue}&filter=${filter}" class="pagination__prev-link">
                                                                <i class="fas fa-chevron-left"></i>
                                                            </a>
                                                        </c:otherwise>
                                                    </c:choose>
                                                ...
                                                <ul class="pagination__page">
                                                    <c:forEach items="${paginationList}" var="pagination" varStatus="status">
                                                        <li class="pagination__page-number">
                                                            ...
                                                            <c:if test="${indexOfPageIndex != status.index}">
                                                                <a href="/manager/home/active?page=${pagination}&searchValue=${searchValue}&filter=${filter}" class="pagination__page-link">${pagination}</a>
                                                            </c:if>
                                                        </li>
                                                    </c:forEach>
                                                </ul>
                                                ...
                                                <div class="pagination__next">
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <a href="/manager/home/active?page=${pageIndex + 1}&searchValue=${searchValue}&filter=${filter}" class="pagination__next-link">
                                                                <i class="fas fa-chevron-right"></i>
                                                            </a>
                                                        </c:otherwise>
                                                    </c:choose>
