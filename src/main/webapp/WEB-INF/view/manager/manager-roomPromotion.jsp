...
<head>
    ...
    <title>Home | Room Promotion Code - Hotel Management</title>
</head>
<body>
    <!-- Header -->
                        ...
                        <div class="management__dashboard-upper">
                            <ul class="management__dashboard-heading-list">
                                <li class="management__dashboard-heading-item">
                                    <a class="square-btn management__dashboard-heading-link active">Room Promotion Code</a>
                                </li>
                                <li class="management__dashboard-heading-item">
                                    <a href="/manager/promoCode/service" class="square-btn management__dashboard-heading-link">Service Promotion Code</a>
                                </li>
                            </ul>
                            <div class="management__dashboard-monitor">
                                <input type="hidden" data-csrf-token="1" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                <form action="/manager/promoCode/room" method="get" class="management__dashboard-search">
                                ...
                                <div class="table-background-layer">
                                    <table class="table-foreground-layer management__room-promotion-table">
                                        <thead>
                                            <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <c:choose>
                                                            ...
                                                            <c:when test="${code.currentStatus == 'expired'}">
                                                                <td>
                                                                    <div class="management__room-type-table-btns">
                                                                        <span class="pill-btn management__room-type-expired-btn">Expired</span>
                                                                        <span class="pill-btn red-type-btn management__room-type-delete-btn">Delete</span>
                                                                    </div>
                                                                </td>
                                                            </c:when>
                                                        </c:choose>
                                                        <input type="hidden" name="roomPromoId" value="${code.roomPromoId}"/>
                                                    </tr>
                                                </c:forEach>
                                            </c:if>
                                        </tbody>
    ...
    <script src="/assets/js/staff/manager-roomPromotion.js"></script>
</body>
</html>
