...
<head>
    ...
    <title>Check Out | Booking Code - Hotel Management</title>
</head>
<body>
                    ...
                    <div class="management__dashboard">
                        <div class="management__dashboard-upper">
                            ...
                            <div class="management__dashboard-monitor">
                                ...
                                <form action="/staff/checkOut/${directory}" method="get" class="management__dashboard-search">
                                            ...
                                            <c:if test="${bookingCodeList.size() > 0}">
                                                <c:forEach items="${bookingCodeList}" var="bc">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="pill-btn blue-type-btn management__bookingcode-table-view-detail">Check-out</div>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                            </c:if>
                                            ...
                                            <c:when test="${paginationList.size() > 0}">
                                                <div class="pagination__prev">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <a href="/staff/checkOut/${directory}?page=${pageIndex - 1}&searchValue=${searchValue}&filter=${filter}" class="pagination__prev-link">
                                                                <i class="fas fa-chevron-left"></i>
                                                            </a>
                                                        </c:otherwise>
                                                    </c:choose>
                                                ...
                                                <ul class="pagination__page">
                                                    <c:forEach items="${paginationList}" var="pagination" varStatus="status">
                                                        <li class="pagination__page-number">
                                                            ...
                                                            <c:if test="${indexOfPageIndex != status.index}">
                                                                <a href="/staff/checkOut/${directory}?page=${pagination}&searchValue=${searchValue}&filter=${filter}" class="pagination__page-link">${pagination}</a>
                                                            </c:if>
                                                        </li>
                                                    </c:forEach>
                                                </ul>
                                                ...
                                                <div class="pagination__next">
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <a href="/staff/checkOut/${directory}?page=${pageIndex + 1}&searchValue=${searchValue}&filter=${filter}" class="pagination__next-link">
                                                                <i class="fas fa-chevron-right"></i>
                                                            </a>
                                                        </c:otherwise>
                                                    </c:choose>
    ...
    <script src="/assets/js/staff/receptionist-checkout-s1.js"></script>
    </body>
</html>
